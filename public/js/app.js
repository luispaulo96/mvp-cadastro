...
__webpack_require__(/*! ./car */ "./resources/js/car.js");
...
var carForm = document.querySelectorAll('#car-form');
carForm.forEach(function (form) {
  form.addEventListener('submit', function (ev) {
    ev.preventDefault();
    var button = form.querySelector('button[type="submit"]');
    button.disabled = true;
    var spinner = button.querySelector('span');
    spinner.hidden = false;
    var divSuccess = form.querySelector('#div-success');
    var divError = form.querySelector('#div-error');
    var formData = new FormData(form);
    var carId = form.querySelector('#hf-id').value;
    ...
    axios({
      method: 'post',
      url: carId ? "/cars/update/".concat(carId) : '/cars/store',
      data: formData
...
loginForm.forEach(function (form) {
  form.addEventListener('submit', function (ev) {
    ...
    var spinner = button.querySelector('span');
    spinner.hidden = false;
    var loginSuccess = form.querySelector('#login-success');
    var loginError = form.querySelector('#login-error');
    var formData = new FormData(form);
    axios({
      method: 'post',
      url: '/login/auth',
...
registerForm.forEach(function (form) {
  form.addEventListener('submit', function (ev) {
    ev.preventDefault();
    var button = form.querySelector('button[type="submit"]');
    button.disabled = true;
    var spinner = button.querySelector('span');
    spinner.hidden = false;
    var registerSuccess = form.querySelector('#register-success');
    var registerError = form.querySelector('#register-error');
    var formData = new FormData(form);
    axios({
      method: 'post',
      url: '/register/send',
